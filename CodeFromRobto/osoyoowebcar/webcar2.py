...
#import RPi.GPIO as GPIO
pi_ip_address= '130.215.9.186'
####################PI IP ADDRESS


#'localhost'#'localhost'#'0.0.0.0'#'192.168.0.32' # replace 192.168.0.107 with your Raspberry Pi IP address
...
#make robot keep checking its values for how to move. use python time??? --- done!!
...
def turnCam(camDir):
    ...
    print(camDir)
    if camDir == CamDirection.RIGHT.value:
